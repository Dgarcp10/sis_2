...
public class Recibos  implements java.io.Serializable {
     ...
     @Transient
    private double reciboBruto;
     
    public Recibos() {
    }

	
    public Recibos(Contribuyente contribuyente, Vehiculos vehiculos, Date fechaPadron, Date fechaRecibo, String nifContribuyente, String direccionCompleta, String tipoVehiculo, String marcaModelo, String unidad, double valorUnidad, double totalRecibo, String ayuntamiento) {
    ...
    public double getReciboBruto() {
        return reciboBruto;
    }

    public void setReciboBruto(double reciboBruto) {
        this.reciboBruto = reciboBruto;
    }
